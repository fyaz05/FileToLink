...
async def get_file_ids(client: Client, chat_id: int, message_id: int) -> FileId:
    ...
    try:
        ...
        logger.error(f"File ID processing failed: {str(e)}")
        raise
