...
async def run_speedtest() -> tuple[dict[str, Any] | None, str | None]:
    try:
...
def _perform_speedtest() -> tuple[dict[str, Any] | None, str | None]:
    try:
        ...
        try:
            ...
            logger.debug("Failed to generate speedtest share link")
            return results, None
